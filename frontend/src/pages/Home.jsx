    ...
    <div>
      ...
      <div className="grid" style={{ marginBottom: '2rem' }}>
        <article style={{ padding: '1rem', textAlign: 'center' }}>
          ...
          <p>Total People</p>
          <Link to="/people" role="button" className="secondary">View All</Link>
        </article>
        <article style={{ padding: '1rem', textAlign: 'center' }}>
          <h3>{stats.totalEvents}</h3>
          <p>Total Events</p>
          <Link to="/events" role="button" className="secondary">View All</Link>
        </article>
        <article style={{ padding: '1rem', textAlign: 'center' }}>
          <h3>{stats.totalSmallGroups}</h3>
          <p>Small Groups</p>
          <Link to="/small-groups" role="button" className="secondary">View All</Link>
        </article>
      </div>
